...
#
# Generated by export_simulation on Thu Jan 05 21:09:34 +0800 2017
#
################################################################################
...
switch to the './ic_players_img.sh' script.

./ic_players_img.sh -reset_run
...
./ic_players_img.sh -noclean_files

For more information on the script, please type './ic_players_img.sh -help'.
