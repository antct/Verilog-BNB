...
#
# Generated by export_simulation on Thu Jan 05 21:03:54 +0800 2017
#
################################################################################
...
switch to the './ic_menu_img.sh' script.

./ic_menu_img.sh -reset_run
...
./ic_menu_img.sh -noclean_files

For more information on the script, please type './ic_menu_img.sh -help'.
