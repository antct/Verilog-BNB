...
#
# Generated by export_simulation on Thu Jan 05 21:04:35 +0800 2017
#
################################################################################
...
switch to the './ic_about_img.sh' script.

./ic_about_img.sh -reset_run
...
./ic_about_img.sh -noclean_files

For more information on the script, please type './ic_about_img.sh -help'.
