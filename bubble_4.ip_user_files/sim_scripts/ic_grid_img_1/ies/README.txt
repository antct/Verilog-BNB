...
#
# Generated by export_simulation on Thu Jan 05 21:12:36 +0800 2017
#
################################################################################
...
switch to the './ic_grid_img.sh' script.

./ic_grid_img.sh -reset_run
...
./ic_grid_img.sh -noclean_files

For more information on the script, please type './ic_grid_img.sh -help'.
