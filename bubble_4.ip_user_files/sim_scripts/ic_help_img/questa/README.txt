...
#
# Generated by export_simulation on Thu Jan 05 21:07:15 +0800 2017
#
################################################################################
...
switch to the './ic_help_img.sh' script.

./ic_help_img.sh -reset_run
...
./ic_help_img.sh -noclean_files

For more information on the script, please type './ic_help_img.sh -help'.
