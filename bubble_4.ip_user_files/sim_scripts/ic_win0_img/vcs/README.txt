...
#
# Generated by export_simulation on Thu Jan 05 21:10:22 +0800 2017
#
################################################################################
...
switch to the './ic_win0_img.sh' script.

./ic_win0_img.sh -reset_run
...
./ic_win0_img.sh -noclean_files

For more information on the script, please type './ic_win0_img.sh -help'.
